...
def test_project_lifecycle_and_analytics(client: TestClient, db_session: Session, tenant_a: TenantContext):
    employee, headers = _create_employee_with_user(db_session, tenant_a.company_id, UserRole.super_admin)
...
def test_daily_time_entry_hour_limit(client: TestClient, db_session: Session, tenant_a: TenantContext):
    employee, headers = _create_employee_with_user(db_session, tenant_a.company_id, UserRole.super_admin)
