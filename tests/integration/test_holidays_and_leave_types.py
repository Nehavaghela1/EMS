...
def test_company_approval_seeds_leave_types_from_the_industry_preset(client, super_admin_headers):
    ...
    token = _login(client, approve["hr_admin_email"], approve["temporary_password"])
